...
export default class NotificationPermissionPlugin extends Plugin {
    static name = "polyfill/notificationPermission";
    ...
    async addInitScript(context) {
        if ("chromium" === context.browser().browserType().name() &&
            ...
            return {
                path: await import.meta.resolve("./notification-permission" +
                                                                ".injected.js"),
            };
        }
