    ...
    describe("chromium", function () {
        it("should not lose your head in headless", async function () {
            ...
            try {
                ...
                await fs.writeFile("./log/guillotine-cr_headless.html",
                                   await page.content());
        ...
        it("should not lose your head in headfull", async function () {
            ...
            try {
                ...
                await fs.writeFile("./log/guillotine-cr_headfull.html",
                                   await page.content());
    ...
    describe("firefox", function () {
        it("should not lose your head in headless", async function () {
            ...
            try {
                ...
                await fs.writeFile("./log/guillotine-fx_headless.html",
                                   await page.content());
                await page.screenshot({
                    path:     "./log/guillotine-fx_headless.png",
                    fullPage: true,
                });
        ...
        it("should not lose your head in headfull", async function () {
            ...
            try {
                ...
                await fs.writeFile("./log/guillotine-fx_headfull.html",
                                   await page.content());
                await page.screenshot({
                    path:     "./log/guillotine-fx_headfull.png",
                    fullPage: true,
                });
